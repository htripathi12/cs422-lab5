...
/* Adapted for CS networking courses by park oct 2019 */
/* To compile: gcc -o muaudio muaudio.c -lasound */
/* Usage: main() reads from .au audio file given as argv[1] in blocks of 
	bufsiz = 4096 bytes and writes to alsa audio device in blocks of bufsiz. 
	Betweem successive read/writes code sleeps for slptime microseconds
	given by argv[2]. Use default value 313000 */
/* Use /usr/bin/aplay on amber machines to check audio quality of pp.au and kj.au 
